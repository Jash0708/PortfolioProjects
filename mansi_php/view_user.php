    ...
    <tbody>
	 ...
	 ?>
      ...
      <tr>
		...
		<td><a class = "btn btn-danger" href="view_user.php?del=<?php echo $user_id;?>">Delete</td>
		<td><a class = "btn btn-success" href="update_user.php?update=<?php echo $user_id;?>">Update</td>
